...
<div class="line">
	<div class="unit size3of4">
		...
		<?php
			...
			if ( have_posts() ) {
				the_post(); ?>
				<h1><span>f</span><?php the_author_meta('user_firstname') ?>  has  <?php the_author_posts(); ?> post(s)</h1>
				...
				<?php } else { ?>
					...
					<div class="news-wrapper">
						...
						<div class="line drawer">
							...
							<div class="avatarcircle"><?php echo '<a href="?author=' . get_the_author_meta('ID') . '">' . get_avatar( get_the_author_meta('ID'), $size = '120' );
