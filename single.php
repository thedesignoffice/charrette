...
<div class="line">
	<div class="unit size3of4 ">
		...
		<h1 class="article"><div style="float: right; letter-spacing: 10px;" class="mpix large grey">
					 <?php previous_post_link('%link', '‘', TRUE); ?><?php next_post_link('%link', '—', TRUE); ?> 
			</div>
			<span><?php echo get_avatar( get_the_author_meta('ID'), $size = '22' ); 
